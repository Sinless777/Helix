...
export const CloudPlatformCards: CardProps[] = [
  {
    ...
    listItems: [
      ...
      },
      {
        ...
        role: "Frontend Cloud",
        detailedDescription:
          "Vercel optimises Next.js 14 edge‑rendering, Server Actions, and image optimisations across a global edge, with AI SDK for hitting OpenAI and Claude endpoints securely."
      },
      // Added Aug 2025
      {
        text: "Linode",
