...
export const queryCode = `query FullQuery{root{permissionsSystem}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"permissionsSystem":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};

export const vercelFlagDefinitions = {"permissionsSystem":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/6974/main/draft/logic?selected_field_path=root%3EpermissionsSystem"}};
...
const rootFallback = {permissionsSystem:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/6974/main/draft/logic?selected_field_path=root%3EpermissionsSystem})
   */
...
const sourceFallback = {root:{permissionsSystem:false}};
