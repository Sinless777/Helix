// libs/core/src/lib/constants/frontend/technology/ProgrammingLanguages.ts
...
export const ProgrammingLanguagesCards = [
  {
    ...
    image:
      'https://cdn.sinlessgamesllc.com/Helix-AI/images/technology/Programming-Languages.png',
