...
describe('SecurityCards constant', () => {
  ...
  it('matches the snapshot of SecurityCards', () => {
    expect(SecurityCards).toMatchSnapshot()
  })
})
