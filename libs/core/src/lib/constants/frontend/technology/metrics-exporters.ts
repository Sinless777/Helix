 ...
 * @example
 * ```ts
 * import { MetricsExportersCards } from "@/constants/technology/metrics-exporters";
 * ```
 */
export const MetricsExportersCards: CardProps[] = [
  {
    ...
    image:
      'https://cdn.sinlessgamesllc.com/Helix-AI/images/technology/Metrics-Exporters.png',
