...
export const DevelopmentCards: CardProps[] = [
  {
    ...
    listItems: [
      ...
      },
      {
        ...
        detailedDescription:
          'Home to 100 M+ developers with Issues, Discussions, Dependabot, and Codespaces cloud IDEs. Recent additions include AI‑powered code search and reusable project templates prewired with Actions workflows.',
      },
      {
        text: 'GitLab',
