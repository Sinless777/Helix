import { navSections as originalNavSections, NavItem as NavItemOriginal, NavSection as NavSectionOriginal } from './navigation';
import { Citations as originalCitations, APACitation as APACitationOriginal, CitationPageData as CitationPageDataOriginal } from './citations';
import { type Phase as PhaseOriginal, type Task as TaskOriginal, KeyValuePillars as originalPillars, InnovationCriteria as originalCriteria, RoadmapPhases as RoadmapPhasesOriginal } from './grand_vision';
...
describe('Docs index exports', () => {
  ...
  it('should re-export Citations and types correctly', () => {
    ...
    type CheckAPACitation = APACitation extends APACitationOriginal ? true : false;
    type CheckCitationPageData = CitationPageData extends CitationPageDataOriginal ? true : false;
  ...
  it('matches the snapshot of Docs index exports', () => {
    expect({ navSections, Citations, RoadMap, KeyValuePillars, InnovationCriteria, nodes, edges }).toMatchSnapshot();
  });
});
