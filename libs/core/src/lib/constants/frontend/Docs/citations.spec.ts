  ...
  it('should contain an array of APACitation objects', () => {
    ...
    Citations.citations.forEach((citation: APACitation) => {
      ...
      if (citation.volume !== undefined) {
        expect(
          typeof citation.volume === 'string' || typeof citation.volume === 'number'
        ).toBe(true);
      }
      if (citation.issue !== undefined) {
        expect(
          typeof citation.issue === 'string' || typeof citation.issue === 'number'
        ).toBe(true);
      }
      ...
      expect([
        'academic','legal','Third-Party Application','Programming Package','AI Model',
        'AI Service','AI Platform','AI Framework','AI Library','AI Tool','AI API','AI SDK',
        'AI Plugin','AI Extension','AI Component','AI System','AI Architecture',
        'AI Design Pattern','AI Methodology','AI Approach','AI Technique'
