...
export const metadata: Metadata = {
  ...
  description:
    'Discover HelixAI Technologies: innovative AI platforms, machine-learning infrastructure, and integrations that empower developers and enterprises to build intelligent applications at scale.',
  keywords: [
  ...
  openGraph: {
    title: 'HelixAI Technologies | Advanced AI Solutions & Architecture',
    description:
      'Explore HelixAI Technologies: cutting-edge AI platforms, ML infrastructure, and integrations designed for seamless enterprise and developer adoption.',
