...
export const metadata: Metadata = {
  ...
  description: "Get in touch with the Helix AI team for product support, sales inquiries, or partnership opportunities. We're here to help you harness the power of adaptive AI in your workflows.",
  keywords: [
    'Contact Helix AI',
    'Helix AI support',
    'Helix AI sales',
  ...
  twitter: {
    ...
    title:       'Contact Helix AI | Reach Out for Support, Sales & Partnerships',
    description: 'Have questions or need help? Contact Helix AI for support, sales, or partnership opportunities. Our team is ready to assist you.',
