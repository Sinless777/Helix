...
const contactOptions = [
  {
    ...
    description: 'Connect with the community and get real-time support. Chat with the team, suggest ideas, and stay updated.',
  ...
  {
    title: 'Email Support',
    description: 'Need help? Contact our support team directly. We typically respond within 24–48 hours.',
  ...
  },
  {
    ...
    description: 'Got an idea? Help shape the future of Helix AI by following our GitHub issue template.',
  ...
  {
    title: 'Report a Bug',
    description: 'Found something that doesn&apos;t work quite right? Let us know and we&apos;ll investigate promptly.',
  ...
  {
    title: 'Give Feedback',
    description: 'Your opinion matters. Share your thoughts on your experience with Helix AI and help us improve.',
            ...
            <Grid key={index} size={{ xs: 12, sm: 6, md: 4 }}>
              ...
              >
                <CardContent>
                  ...
                  <Typography variant="body2" sx={{ color: 'white', fontSize: '1.0rem' }} gutterBottom>
                    {option.description}
                  </Typography>
                  <Button
                    variant="contained"
