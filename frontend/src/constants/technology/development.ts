...
export const DevelopmentCards: CardProps[] = [
  {
    ...
    listItems: [
      { text: 'GitHub Actions', href: 'https://github.com/features/actions', role: 'CI/CD Automation' },
      { text: 'FluxCD', href: 'https://fluxcd.io/', role: 'GitOps Tool' },
      { text: 'ArgoCD', href: 'https://argoproj.github.io/argo-cd/', role: 'GitOps for Kubernetes' },
